...
\begin{M}\normalfont Input Format Module
\label{M_InputFormat}
\end{M}

\begin{M}\normalfont Input GPA Module
\label{M_InputGPA}
\end{M}

\begin{M}\normalfont Output Format Module
\label{M_OutputFormat}
\end{M}

\begin{M}\normalfont Output GPA Module
\label{M_InputGPA}
\end{M}
...
\toprule
\textbf{Level 1} & \textbf{Level 2} & Level 3\\
\midrule
