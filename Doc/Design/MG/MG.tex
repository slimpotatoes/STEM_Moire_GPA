...
\label{M_Hardware} \wss{The links in the document are very handy for navigating
...
\wss{Great start for your design.  You might need to iterate based on what you
  learn writing the access programs for the modules in the MIS, but you are
