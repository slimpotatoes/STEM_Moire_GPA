...
original design was not optimal and I tried to fit every verification step in 
this input module. This is clearly not appropriate and I should design another 
module to verify the GUI inputs (M,U,n and m) separately. I just realized it too 
late to make the modification before the deadline but I will change that for 
sure.}
